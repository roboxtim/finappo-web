      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Compare the financial outcomes of renting versus buying a home to
            make an informed decision about your housing situation.
          </p>
        </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange('buyingClosingCosts', e.target.value)
                      }
                      className="w-full pl-8 pr-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-gray-900 font-medium"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange('rentIncreaseRate', e.target.value)
                        }
                        step="0.1"
                        className="w-full pl-4 pr-8 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-gray-900 font-medium"
                      />
          ...
          <div className="prose max-w-none text-gray-700">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li>
                    <strong>Market Conditions:</strong> Home appreciation rates
                    and rent increases significantly impact the calculation.
                  </li>
                  <li>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm font-mono bg-white p-2 rounded">
                      Savings = (Interest + Property Tax - Std Deduction) × Tax
                      Rate
                    </p>
                  </div>
                </div>
            ...
            <div className="mt-8 p-6 bg-blue-50 rounded-lg">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  • Results are based on assumptions about future appreciation,
                  rent increases, and investment returns, which are inherently
                  uncertain.
                </li>
                <li>
                  • Tax benefits depend on itemizing deductions, which may not
                  be advantageous for everyone given current standard deduction
                  levels.
                </li>
                <li>
            ...
            <div className="mt-8">
              ...
              <ul className="space-y-2">
                ...
                <li>✓ You have savings for down payment and emergency fund</li>
                <li>
                  ✓ You want to build equity and have a hedge against inflation
                </li>
                <li>
            ...
            <div className="mt-8">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  ✓ You&apos;re still building your credit or saving for a down
                  payment
                </li>
              </ul>
            </div>
