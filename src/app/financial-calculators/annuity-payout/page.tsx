          ...
          <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-3xl p-6 border border-blue-100">
            ...
            <ul className="space-y-2 text-sm text-gray-700">
              ...
              <li className="flex items-start gap-2">
                <span className="text-blue-600 mt-0.5">•</span>
                <span>
                  View the detailed amortization schedule to see year-by-year
                  balance changes
                </span>
              </li>
            </ul>
            ...
            <>
              ...
              <div className="bg-gradient-to-br from-blue-600 to-cyan-600 rounded-3xl p-8 text-white shadow-xl">
                ...
                {results.willGrow && (
                  <div className="mt-4 p-4 bg-yellow-400/20 backdrop-blur rounded-xl border border-yellow-400/30">
                    <p className="text-sm">
                      ⚠️ The payment amount is less than the interest earned.
                      The annuity will grow instead of depleting.
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-4">
                  ...
                  <p className="text-lg font-semibold text-gray-900">
                    {formatCurrency(parseFloat(principal.replace(/,/g, '')))}
                  </p>
                </div>
              </div>
                  ...
                  {showSchedule && (
                    <div className="overflow-x-auto">
                      <table className="w-full text-sm">
                        ...
                        <tbody>
                          {results.schedule.map((entry: AmortizationEntry) => (
                            <tr
                              key={entry.year}
