                ...
                <div className="flex items-center justify-between text-white">
                  <div>
                    ...
                    <p className="text-white/90 text-lg">
                      You&apos;ll save {formatCurrency(results.savings)} over
                ...
                >
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center py-3 border-b border-gray-200">
                      ...
                      <span className="font-semibold text-gray-900">
                        {formatCurrency(results.cashBackOption.monthlyPayment)}
                      </span>
                    </div>
                    ...
                    <div className="flex justify-between items-center py-3 border-b border-gray-200">
                      ...
                      <span className="font-semibold text-gray-900">
                        {formatCurrency(results.cashBackOption.totalInterest)}
                      </span>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-blue-50 rounded-xl p-4">
                      ...
                      <div className="text-2xl font-bold text-blue-900">
                        {formatCurrency(results.lowInterestOption.loanAmount)}
                      </div>
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 mt-4">
                      ...
                      <div className="text-xl font-bold text-gray-900">
                        {formatCurrency(results.lowInterestOption.totalPaid)}
                      </div>
                      <div className="text-xs text-gray-500 mt-1">
                        Including {formatCurrency(downPayment)} down payment
                      </div>
      ...
      >
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            ...
            <ul>
              <li>
                <strong>Cash Back Option:</strong> Receive an immediate rebate
                that reduces the loan amount, but finance at a higher interest
                rate
              </li>
              <li>
                <strong>Low Interest Option:</strong> Finance the full amount
                (minus down payment) at a promotional lower interest rate
                without the cash rebate
              </li>
            </ul>
            <p>
              The calculator uses standard loan amortization formulas to compute
              monthly payments, total interest paid, and overall cost for each
              option, helping you identify which deal truly saves you more money
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                <p className="text-gray-700">
                  ...
                  <br />
                  <br />
                  <strong>Winner:</strong> The option with the lower total cost
            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                <p className="text-gray-700">
                  The break-even point is calculated by dividing the cash back
                  amount by the monthly payment difference:
                </p>
                ...
                <p className="text-gray-700 mt-3">
                  If the break-even point is less than your loan term, the low
                  interest option will eventually save you more money.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start">
                  ...
                  <span>Large rebate amount relative to purchase price</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-600 mr-2">•</span>
        ...
        <div className="bg-amber-50 rounded-2xl shadow-xl p-8 border border-amber-200">
          ...
          <div className="space-y-4 text-amber-900">
            <p>
              <strong>Tax Implications:</strong> Some states don&apos;t charge
              sales tax on manufacturer rebates, which could provide additional
              savings with the cash back option.
            </p>
            <p>
              <strong>Loan Terms:</strong> Make sure both offers have the same
              loan term, or adjust your comparison accordingly.
            </p>
            <p>
            ...
            <p>
              ...
              excellent credit. Make sure you qualify for the advertised rate.
            </p>
            <p>
              <strong>Total Cost Focus:</strong> Don&apos;t just compare monthly
              payments - focus on the total amount you&apos;ll pay over the life
              of the loan.
            </p>
          </div>
        </div>
